...
import { footerContent, siteConfig, galleryImages } from '@/content/data'
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <a
                href="mailto:hello@queenofcompass.com"
                className="inline-flex items-center gap-3 px-10 py-4 bg-gold-400 text-olive-900 font-bold rounded-full shadow-2xl hover:bg-gold-300 transform hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/queen.of.compass/" target="_blank" className="text-olive-400 hover:text-gold-400 transition-colors">
